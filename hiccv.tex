...
\item[Ph.D supervision - Ongoing]\ \\
  \begin{enumerate}
  \item ``Autonomous Micro-Mobility'', David Paz, ECE @ UCSD (2023)
  \item ``ML for Autonomy'', Quan Voung, CS @ UCSD (2023)
  \item ``Affordance based manipulation'', Andrea Frank, CSE @ UCSD (2022)
...
\item[Courses taught:]
  \begin{enumerate}
  \item Introduction to Robotics (CSE276A -- 2018, 2019)
  \item Mathematics for Robotics (CSE276C -- 2018, 2019)
