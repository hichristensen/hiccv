...
\begin{cv}
	...
	\begin{cvlist}{Professional Experience:}
		\item[Apr 2025 -- Mar 2026] Fellow, Temasek International, Singapore. (Part time)
		...
		\item[Feb 2019 -- Oct 2025] Co-founder of Robust.AI, Palo Alto, CA
		...
		\item[Oct 2013 - Jul 2016] Founding Executive Director, ``Institute for
		Robotics and Intelligent Machines'', Georgia Institute of Technology --
		IRIM --- a unit that involves more than 60 faculty and 150 graduate
		students doing research, education and translation of robotics across
		...
		track the global robotics and automation market. Chairman of AI Strategy
		and general robotics advisor. Robo-Stox, is an exchange traded fund
		(ETF) on NYSE with the ticker symbol ROBO.\@ A parallel fund was
		launched at London Stock Exchange 2014. The international company was
		renamed Robo-Global from Robo-Stox January 2016.\@ Robo-Global was
		acquired by VettaFi April 2023.

		\item[June 2013--] Co-founder/Partner of ``Christensen Consulting Group'',
	...
	\begin{cvlist}{Consulting Experience:}
		...
		\begin{sublist}
			...
			\item Dean's Advisory Board --- Fowler School of Engineering, Chapman University (2020--2024)
			\item Member of Board / Advisor --- OnRobot  (2018--2019)
			\item Covariant.AI --- Advisory Board (2018--2019)
			\item Ready Robotics --- Chair of Advisory Board (2017--2019)
			\item Board of Directors --- Blue Ocean Robotics (2016--2018)
			\item Tech Mahindra --- Manufacturing Advisory Board (2015--2018)
			\item General Electric --- Robotics Advisory Board (2015--2016)
			\item Consultant --- The Boeing Company --- Strategic Automation Roadmap (2015)
			\item Board of Directors --- Universal Robots Inc. (2014--2016)
			\item DARPA DRC Impact Study \& Student Contest (2013--2015)
			\item CLSA --- Robotics \& Automation (2014--2016)
			\item Consultant --- Symbotic (2014)
			\item Board of Directors --- MAG-IAS Composites  (2010--2013)
			\item Advisor -- C\&S WholeSale (2010--2011)
			...
			\item Consultant --- iRobot (2004--2006)
			\item Advisor --- ABB (2001--2005)
			\item Consultant -- Totoya Motor Company (2000--2004)
	...
	\begin{cvlist}{~}
		...
		\begin{enumerate}
			\item ``Robust Autonomy'', Chenghao Li, CS@UCSD (2029)
			\item ``Multi-Robot Semantic Mapping'', Yang Liao, CS@UCSD (2029)
			\item ``Data acquisition for platform agnostic learning'', Jiawei Fu, CS@UCSD (2029)
			\item ``ML for high performance robot manipulation'', Weijun Dong, CS@UCSD (2029)
			\item ``Physical Based Simulation for Learning'', Xiaodi Yuan, CS@UCSD (2028)
			\item ``Prediction for Autonomous Vehicles'', Jing-yan Liao, CS@UCSD (2027)
			\item ``Intent Recognition for Autonomous Systems'', Zihan Zhang, CS@UCSD (2027)
			\item ``Behavior Planning in Urban Environments'', Luobin Wang, CS@UCSD (2027)
			\item ``Robot Learning from Minimal Human Intervention'', Weikang Wan, CS@UCSD (2027)
			\item ``Adversarial Planning using Game Theory'', Rohan Patil, CS@UCSD (2027)
			\item ``Mapping for Autonomous Vehicles'', Seth Farrell, CS@UCSD (2027)
			\item ``Autonomy for First-Responder Support'', Julian Raheema, CS@UCSD (2027)
			\item ``Simulation integrated machine learning'', Stone Tao, CS@UCSD (2026)
		\end{enumerate}

		\item[Ph.D supervision - Completed]\ \\
		\begin{enumerate}
			\item ``Democratizing Robot Visual Learning'', Abdulaziz Almuzairee, CS@UCSD (2026)
		...
		\begin{enumerate}
			...
			\item Mathematics for Robotics (CSE276C --- 2018--2024, 2026--)
	...
	\begin{cvlist}{Keynote / Plenary Presentations}
		\item
		\begin{enumerate}
      \item ``Human Centered Autonomy'', {\em IEEE International Conference on
            Mechatronics and Automation (ICMA 2026)}, Changchun, China, Aug 2026
      \item ``Building a perception stack for autonomous driving'', {\em Intl.
            Conf. Pattern Rec.}, Lyon, FR, Aug 2026
			\item ``A global perspective on robotics and AI'', {\em LGIM Symposium}, London, Jun 2026
			\item ``From Surgical Robots to Embedded Clinical Intelligence'', {\em Hamlyn Symposium}, London, Jun 2026
			\item ``The confluence of technologies for robotics'', {Lorang AI}, Singapore, March 2026
			\item ``Investing in Robotics and AI'', {\em WEF 2026}, Davos, Jan 2026
			\item ``Systems Integration for Micro-Mobility'', {\em IEEE/SICE International
				      Symposium on System Integration (SII 2026)}, Cancun, MX, Jan 2026
			...
			\item ``Vision based robotics'', BAU Futures of Robotics, Istanbul, June 2015
	...
	\begin{cvlist}{Patents and Invention Disclosures}
		\item Mobile Robot, P. Jensfelt \& H.I. Christensen, World Patent (EP1804149).
		\item F{\"o}rfarande f{\"o}r en anordning p{\aa} hjul (Eng: Methods for a thing
    on wheels), G. Zunino \& H.I. Christensen, Swedish Patent (SE0200197)
		\item Position Estimation Method, H.I. Christensen \& G. Zunino, World patent
    (WO03062937)
		\item FoD Detection using Laser Scanning, A. Trevor \& H. I. Christensen, GT
    Invention 5850 / Prov. Patent 61/694,361
		\item Verification of as Built Structures, A. Trevor \& H.I. Christensen, GT
    Invention 5851 / Prov. Patent 61/694,378
		\item CAD Simplification for Visual Servoing. C. Choi \& H.I. Christensen, GT
    Invention 5162
		\item Mapping with Virtual Measurements, J. G. Rogers, A. Trevor and H. I.
    Christensen, GT Invention 5160
		\item Optical Measurements of Drilled Holes, K. Hatzilias, H. Bergman, \& H. I.
    Christensen, US Patent 8,842,273
		\item A method for relieve confusion in Alzheimer patients based on in-Ear EEG
    monitoring, H. I. Christensen \& T. Anderson (Provisional 2016)
		\item Robotic Destination Dispatch Sytem for Elevators and Methods for Making
    and Using Same,, S. Park, M. Bray, A. Cosgun \& H. I. Christensen, US Patent
    (US20190345000A1), 2018
	\end{cvlist}
	...
	\begin{cvlist}{Professional Service}%
		...
		\begin{itemize}
			...
			\item IEEE Fellow \cftdotfill{\cftdotsep} 2015\\
			      ...
			      \begin{itemize}
				      ...
				      \item RAS AwardNominations Co-Chair \cftdotfill{\cftdotsep} 2008, 2009
		...
		\begin{itemize}
			...
			\item Co-chair of IC Award Committee, \cftdotfill{\cftdotsep} 2012
		...
		\begin{itemize}
			...
			\item 6th European Conference of Computer Vision, Member of Programme Committee,
			      Dublin, June 2000.
			\item International Joint Conference on Artificial Intelligence, Member of
			      Programme Committee, August 1999.
			\item European Conference on Artificial Intelligence, Member of Programme
			      Committee, Brigh\-ton (UK), 23--28 August 1998
		...
		\begin{itemize}
			...
			\item DFG --- SFB Panel in Robotics / Embedded Systems,
			      Bonn,\cftdotfill{\cftdotsep} June 2018, Oct.~2023
			\item EPSRC UK Robotics and Artificial Intelligence Hubs in Extreme
			      and Challenging Environments \cftdotfill{\cftdotsep} June 2017
	...
	\begin{cvlist} {\bf Editorial Leadership}
		\item Associate Editor {\em IEEE Robotics and Automation Practice}, \cftdotfill{\cftdotsep} 2024--
	...
	\begin{cvlist}{\bf Leadership in organisation of meetings:}
    \item ISRR-2026, Co-organizer, Malacca, Malaysia \cftdotfill{\cftdotsep} Nov. 2026
		\item IROS-2026, Finance co-chair, Pittsburgh, PA \cftdotfill{\cftdotsep} Oct. 2026
		\item IROS-2026, Co-Chair of Senior PC, Pittsburgh, PA \cftdotfill{\cftdotsep} Oct. 2026
		\item ISER-2025, Co-Organizer, Santa Fe, NM, \cftdotfill{\cftdotsep} Jul. 2025
		\item ISRR-2024, Co-organizer, Los Angeles, CA \cftdotfill{\cftdotsep}  Nov. 2024
		\item EON - Edge of Now, Advisor, Laguna Beach, \cftdotfill{\cftdotsep} Sep. 2023
		\item Intl Conference on Vision Systems - PC-Co-Chair, Vienne, \cftdotfill{\cftdotsep} Oct. 2023
		\item EON - Edge of Now, Chief Advisor, Palm Springs, \cftdotfill{\cftdotsep}	Oct. 2022
		\item Gordon Research Conference on Robotics, General Chair, Ventura,	\cftdotfill{\cftdotsep}, Aug. 2022
		\item ICPR-2022 - General Co-Chair, Montreal, \cftdotfill{\cftdotsep} Aug. 2022
		\item ICRA-2022 - Chair of Forums, Philadelphia, \cftdotfill{\cftdotsep} May 2022
	...
	\begin{cvlist}{\bf Research Grants:}
		\item NSF: AI Institute TILOS: Advancing AI and Optimization for
		Intelligent Systems (\$15m, 2026--2030), Co-PI
		\item Qualcomm: Diffusion Based Planning (\$100k, 2026--2027)
		\item SAAB: Sensor Fusion and AI for Security Applications (\$100k, 2025--2026), PI
	...
	\begin{cvlist}{Honors and Awards:}
		...
		\item IEEE RAS - George Saridis Leadership Award, June 2026
