...
\begin{cv}
	...
	\begin{cvlist}{~}
		...
		\begin{enumerate}
			...
			\item ``Data acquisition for platform agnostic learning'', Jiawei Fu, CS@UCSD (w. Hao Su, 2029)
			\item ``ML for high performance robot manipulation'', Weijun Dong, CS@UCSD (w. Hao Su, 2029)
			...
			\item ``Robot Learning from Minimal Human Intervention'', Weikang Wan, CS@UCSD (w. Hao Su, 2028)
			\item ``Physical Based Simulation for Learning'', Xiaodi Yuan, CS@UCSD  (w. Hao Su, 2028)
			...
			\item ``Simulation integrated machine learning'', Stone Tao, CS@UCSD (w. Hao Su, 2027)
		\end{enumerate}
